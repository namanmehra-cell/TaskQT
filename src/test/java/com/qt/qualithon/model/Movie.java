...
public class Movie{
     ...
     *
     * @param maturityRating  maturity rating
     **/
    public void setMaturity(String maturityRating){
    ...
    public String toString(){
      return "Title: " + this.title + " (" + this.releaseYear + ")" + "\n"
            ...
            +"Writers: " + String.join(",", this.writers)+"\n"+"Maturity Rating: "+ String.join(",", this.maturityRating)
            +"\n" + "Rating: "+String.join(",", this.rating); 
    }
}
